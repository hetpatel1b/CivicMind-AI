...
export default function DemoMapView({ onNavigate }: { onNavigate: (view: string, id?: string | null) => void }) {
  return (
    <div className="flex-1 relative overflow-hidden min-h-[calc(100vh-100px)] flex flex-col">
      <div className="w-full max-w-[1600px] mx-auto relative z-10 flex flex-col h-full flex-1 pt-6 px-4">
        ...
        <motion.div 
          ...
          className="w-full flex-1 relative z-0 flex flex-col min-h-[600px] rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl"
        >
